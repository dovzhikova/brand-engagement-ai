...
export default function ReferralCard() {
  ...
  return (
    <div className="card p-6">
      ...
      <div className="bg-surface-50 dark:bg-surface-800/50 rounded-lg p-4 mb-4">
        {referralCode ? (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-surface-600 dark:text-surface-400">Your Referral Code</span>
            </div>
            <div className="flex items-center gap-2">
              <code className="flex-1 text-xl font-mono font-bold text-primary-600 dark:text-primary-400 bg-white dark:bg-surface-900 px-4 py-2 rounded-lg border border-surface-200 dark:border-surface-700 text-center tracking-wider">
                {referralCode}
              </code>
              <button
                onClick={handleCopy}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-surface-50 dark:bg-surface-800/50 rounded-lg p-4 text-center">
          ...
          <p className="text-xs text-surface-500 dark:text-surface-400">Friends Invited</p>
        </div>
        <div className="bg-surface-50 dark:bg-surface-800/50 rounded-lg p-4 text-center">
          <div className="flex items-center justify-center mb-2">
          ...
          <p className="text-xs text-surface-500 dark:text-surface-400">Weeks Earned</p>
        </div>
      </div>

      {/* Subscription Status */}
      {stats?.subscriptionExpiresAt && (
        <div className="mt-4 text-sm text-surface-500 dark:text-surface-400 text-center">
